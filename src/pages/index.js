...
const IndexPage = () => (
  <Layout>
    ...
    <h2 style={{textAlign:"center"}}>About Our Science</h2>
      ...
      <figcaption style={{textAlign:"center"}}><Link style={{textShadow:"none"}} to='attributions'>Figure 1</Link></figcaption>
    ...
    <img style={{margin:0, borderRadius: '10px'}} src={image1}/>
    <figcaption style={{textAlign:"center"}}><Link style={{textShadow:"none"}} to='attributions'>Figure 2</Link></figcaption>
    ...
    <div style={{
        ...
        <figcaption style={{textAlign:"center"}}><Link style={{textShadow:"none"}} to='attributions'>Figure 3</Link></figcaption>
      ...
      <figcaption style={{textAlign:"center"}}><Link style={{textShadow:"none"}} to='attributions'>Figure 4</Link></figcaption>
      ...
      <figcaption style={{textAlign:"center"}}><Link style={{textShadow:"none"}} to='attributions'>Figure 5</Link></figcaption>
